...
class SymObjectConfig:
    # initialize object by passing in path to config file
    # store configuration data in variable data
    def __init__(self, host, port, bot_username, bot_email, token_refresh_period):
        self.data = {}
        self.relative_to = os.curdir
        data = self._makeConfig(host, port, bot_username, bot_email, token_refresh_period)
    ...
    def _makeConfig(self, host, port, bot_username, bot_email, token_refresh_period):
        return {
            "sessionAuthHost": host,
            "sessionAuthPort": port,
            "keyAuthHost": host,
            "keyAuthPort": port,
            "podHost": host,
            "podPort": port,
            ...
            "botPrivateKeyName": "rsa-private-alex.graham+symphonybot2@digitalasset.com.pem",
            "botUsername": bot_username,
            "botEmailAddress": bot_email,
            "appCertPath": "",
            "appCertName": "",
            "appCertPassword": "",
            "proxyURL": "",
            "proxyUsername": "",
            "proxyPassword": "",
            "authTokenRefreshPeriod": token_refresh_period,
            "truststorePath": ""
        }
